...
TICKERS = {
    ...
    "IMOEX": ("2020-01-01", "index", "SNDX")  # Разумная дата начала для индекса
}
...
MAX_RETRIES = 5
BASE_TIMEOUT = 15  # Увеличенный таймаут

# Критически важный заголовок для обхода блокировок Мосбиржи
HEADERS = {
    ...
    while True:
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            try:
                ...
                if not r.text.strip() or "<error>" in r.text.lower():
                    raise Exception(f"Пустой ответ или ошибка в XML: {r.text[:200]}")
...
if __name__ == "__main__":
    ...
    print(f"🌐 Используем User-Agent для обхода блокировок Мосбиржи\n")
